...
- [x] Create SR logo image for social sharing (`images/logo.png`)
...
- [x] **Video Content** - Explainer video on homepage about the process (updated to 1080p landscape)
...
## Destroy Your Beliefs Video Scripts (Completed)

- [x] Created 50 full-length laymen video scripts (15-25 min each)
- [x] Created 50 YouTube metadata files with titles, descriptions, tags
- [x] Organized files into folders: original-chapters, 3-minute-scripts, full-length-scripts, youtube-metadata
- [x] Renumbered chapter files (01=Chapter 1, 02=Chapter 2, etc.)
- [x] Created website-video folder for intro/promo scripts
- [x] Created misc folder for supporting documentation
- [x] Moved video-scripts folder from course to root
- [x] Deleted beliefs folder (contained only first 3 chapters)
- [x] Created course subfolder with 30 script files

## File Organization Updates (Completed)

- [x] Renamed og-image.png/svg to logo.png/svg
- [x] Updated all website references to use logo.png/svg
- [x] Created docs folder and moved progress.md, todo.md
- [x] Updated README.md with new file locations
- [x] Updated YouTube video dimensions to 1080p landscape (16:9)
